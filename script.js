...
function renderProdutos() {
    ...
    function renderFinanceiro() {
                ...
                fixedCosts.forEach((cost, index) => {
                    ...
                    costEl.innerHTML = `
                        ...
                        <div class="flex items-center gap-2">
                            <span class="font-semibold text-slate-700 dark:text-slate-300">${formatCurrency(cost.amount)}</span>                            <button data-index="${index}" class="remove-fixed-cost-btn text-red-500 hover:text-red-700">
                                <i data-lucide="x" class="w-4 h-4 pointer-events-none"></i>
                            </button>
                        </div>
                    `;
        ...
        const updateFinancialReport = () => {
            ...
            // NOVO: Soma os custos fixos da lista salva
        ...
        // Event listener para remover um custo fixo
